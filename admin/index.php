...
<body class="bg-green-50 min-h-screen flex flex-col lg:flex-row">
        ...
        <div class="p-4 md:p-8 space-y-8">
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div class="flex flex-col gap-1">
                    ...
                    <p class="text-green-700 text-sm md:text-base">Manage the evaluation system settings and reports.</p>
                </div>
                <div class="bg-white px-6 py-4 rounded-2xl border border-green-200 shadow-sm flex items-center gap-4">
                    ...
                    <div class="text-right">
                        ...
                        <p id="currentTime" class="text-xl md:text-2xl font-black text-green-600 tabular-nums"></p>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white p-6 rounded-2xl border border-green-300 shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <span class="px-3 py-1 rounded-full text-xs font-black uppercase tracking-widest <?php 
                            echo isset($academic['status']) ? ($academic['status'] == 1 ? 'bg-emerald-100 text-emerald-700' : ($academic['status'] == 2 ? 'bg-red-100 text-red-700' : 'bg-amber-100 text-amber-700')) : 'bg-amber-100 text-amber-700';
                        ?>">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-12">
                ...
                <!-- Teachers who have not yet evaluated (Unevaluated Faculty) -->
                <div class="bg-white rounded-3xl border-2 border-green-200 overflow-hidden shadow-lg shadow-green-900/5 flex flex-col h-[450px]">
                    <div class="bg-green-950 p-6 flex items-center justify-between">
                        <div class="flex items-center gap-3">
