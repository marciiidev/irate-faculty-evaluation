...
<aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-72 bg-green-950 text-white flex flex-col p-6 border-r border-white/5 transition-all transform -translate-x-full lg:translate-x-0 lg:sticky lg:top-0 lg:h-screen shadow-2xl lg:shadow-none shrink-0">
    ...
    <nav class="flex-1 space-y-2 overflow-y-auto">
        ...
        $nav_items = [
            ...
            ['academic.php', 'calendar', 'Academic Year'],
            ['classes.php', 'layers', 'Classes'],
            ['subjects.php', 'book-open', 'Courses'],
            ['criteria.php', 'clipboard-check', 'Criteria'],
            ['questionnaire.php', 'file-text', 'Questionnaire'],
            ['restriction.php', 'lock', 'Restriction'],
            ['report.php', 'file-text', 'Faculty Report'],
            ['academic_archives.php', 'archive', 'Academic Archives'],
            ['completed_evaluations.php', 'list', 'Evaluation Progress'],
            ['backup_data.php', 'database', 'Backup Data'],
        ];
